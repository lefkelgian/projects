	...
	public Worker() {
		...
		btnReserveRooms.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
            	...
            	Reservation a = new Reservation(a);
				a.setVisible(true);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {					
				    ...
				    ps = conn.prepareStatement("update rooms set start_date =?,end_date=? where name_reservation=?");
		...
		label_1.setBounds(212, 126, 46, 14);
		contentPane.add(label_1);
		
		JLabel label_2 = new JLabel("Month");
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_2.setBounds(255, 126, 46, 14);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("Year");
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_3.setBounds(296, 126, 46, 14);
